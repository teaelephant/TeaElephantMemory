...
// Error definitions
var (
	ErrNotEnoughTeas = errors.New("you should have more teas")
)
...
func (r *tagResolver) Category(ctx context.Context, obj *model.Tag) (*model.TagCategory, error) {
	if obj.Category == nil {
		// Explicitly return nil without an error to indicate the category is not set
