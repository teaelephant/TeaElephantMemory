...
func TestWeather_String(t *testing.T) {
	t.Run("no rain", func(t *testing.T) {
		...
		assert.Equal(t, "temperature is -10.500000, clouds percent is 99, no rain, humidity level is 55, wind speed is 56.400000 meter/sec,, visibility is 10000 meters", w.String())
	})
